...
\begin{Problem}
Let $X$ be an uncountable set, and let $\mathscr{R}$ be the ring consisting of all finite subsets of $X$ and their complements. Is $\mathscr{R}$ a $\sigma\rm{-ring}$?
